...
- `mod` [io](#io)
- `fn` [io::println](#ioprintln)
- `fn` [io::print](#ioprint)
- `fn` [io::read_line](#ioread-line)
- `fn` [io::args](#ioargs)
- `mod` [str](#str)
- `fn` [str::len](#strlen)
- `fn` [str::upper](#strupper)
- `fn` [str::lower](#strlower)
- `fn` [str::split](#strsplit)
- `fn` [str::join](#strjoin)
- `fn` [str::trim](#strtrim)
- `fn` [str::to_int](#strto-int)
- `fn` [str::from_int](#strfrom-int)
- `fn` [str::from_float](#strfrom-float)
- `mod` [vec](#vec)
- `fn` [vec::novo](#vecnovo)
- `fn` [vec::len](#veclen)
- `fn` [vec::push](#vecpush)
- `fn` [vec::pop](#vecpop)
- `fn` [vec::map](#vecmap)
- `fn` [vec::filter](#vecfilter)
- `mod` [map](#map)
- `fn` [map::novo](#mapnovo)
- `fn` [map::insert](#mapinsert)
- `fn` [map::get](#mapget)
- `fn` [map::has](#maphas)
- `fn` [map::remove](#mapremove)
- `mod` [math](#math)
- `fn` [math::sqrt](#mathsqrt)
- `fn` [math::pow](#mathpow)
- `fn` [math::fat](#mathfat)
- `fn` [math::abs](#mathabs)
- `fn` [math::min](#mathmin)
- `fn` [math::max](#mathmax)
- `fn` [math::mdiv](#mathmdiv)
- `const` [math::PI](#mathpi)
- `mod` [fs](#fs)
- `fn` [fs::read_arquivo](#fsread-arquivo)
- `fn` [fs::write_arquivo](#fswrite-arquivo)
- `fn` [fs::existe](#fsexiste)
- `mod` [http](#http)
- `struct` [http::Resposta](#httpresposta)
- `fn` [http::get](#httpget)
- `fn` [http::post](#httppost)
- `mod` [json](#json)
- `fn` [json::stringify](#jsonstringify)
- `fn` [json::parse](#jsonparse)
- `enum` [json::Json](#jsonjson)
- `mod` [sqlite](#sqlite)
- `fn` [sqlite::abrir](#sqliteabrir)
- `struct` [sqlite::Db](#sqlitedb)
- `fn` [sqlite::exec](#sqliteexec)
- `fn` [sqlite::query](#sqlitequery)
- `mod` [test](#test)
- `fn` [test::assert](#testassert)
- `fn` [test::assert_eq](#testassert-eq)
- `fn` [test::assert_ne](#testassert-ne)
- `mod` [async](#async)
- `fn` [async::spawn](#asyncspawn)
- `fn` [async::aguardar](#asyncaguardar)
- `mod` [env](#env)
- `fn` [env::var](#envvar)
- `fn` [env::cwd](#envcwd)
- `mod` [time](#time)
- `fn` [time::agora](#timeagora)
- `fn` [time::millis](#timemillis)
- `mod` [result](#result)
- `struct` [result::LumenPanic](#resultlumenpanic)
- `fn` [result::panic](#resultpanic)
- `enum` [result::Option](#resultoption)
- `fn` [result::is_some](#resultis-some)
- `fn` [result::is_none](#resultis-none)
- `fn` [result::unwrap](#resultunwrap)
- `fn` [result::unwrap_or](#resultunwrap-or)
- `enum` [result::Result](#resultresult)
- `fn` [result::is_ok](#resultis-ok)
- `fn` [result::is_err](#resultis-err)
- `fn` [result::q](#resultq)
- `mod` [yaml](#yaml)
- `fn` [yaml::parse](#yamlparse)
- `fn` [yaml::stringify](#yamlstringify)
- `fn` [yaml::read_arquivo](#yamlread-arquivo)
- `fn` [yaml::write_arquivo](#yamlwrite-arquivo)
- `mod` [toml](#toml)
- `fn` [toml::parse](#tomlparse)
- `fn` [toml::stringify](#tomlstringify)
- `fn` [toml::read_arquivo](#tomlread-arquivo)
- `fn` [toml::write_arquivo](#tomlwrite-arquivo)
